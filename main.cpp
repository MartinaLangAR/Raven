...
int main(){
    ...
    //Setup servo models
    mlpack::FFN<> model0;
    mlpack::data::Load("models/model_cam2_6_4_2_it10000_976.xml", "model", model0);
    mlpack::FFN<> model1;
    ...
    int free_counter = 0;
    std::vector<std::pair<int, int>> positions{std::pair<int, int>(50, 50), std::pair<int, int>(55, 55),
                                               std::pair<int, int>(57, 57), std::pair<int, int>(60, 60),
                                               std::pair<int, int>(65, 60), std::pair<int, int>(60, 65),
                                               std::pair<int, int>(60, 67), std::pair<int, int>(60, 70),
                                               std::pair<int, int>(60, 72), std::pair<int, int>(50, 75),
                                               std::pair<int, int>(60, 80), std::pair<int, int>(60, 85),
                                               std::pair<int, int>(50, 80), std::pair<int, int>(50, 78),
                                               std::pair<int, int>(50, 75), std::pair<int, int>(50, 70),
                                               std::pair<int, int>(50, 65), std::pair<int, int>(55, 60),
                                               std::pair<int, int>(50, 60), std::pair<int, int>(47, 63),
                                               std::pair<int, int>(45, 65), std::pair<int, int>(42, 68),
                                               std::pair<int, int>(40, 70), std::pair<int, int>(40, 72),
                                               std::pair<int, int>(40, 70), std::pair<int, int>(40, 68),
                                               std::pair<int, int>(40, 65), std::pair<int, int>(40, 63),
                                               std::pair<int, int>(40, 60), std::pair<int, int>(40, 55)};
